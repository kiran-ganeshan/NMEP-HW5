...
class Data(object):
    ...
    def get_rot_data_iterator(self, images, labels, batch_size):
        ...
        tf.data.Dataset.from_data_slices(images)
        return
    ...
    def preprocess(self, images):
        ...
        images = np.concatenate([images, np.flip(images, axis=(1, 2))], axis=0)
        images = np.concatenate([images, np.rot90(images, axes=(1, 2))], axis=0)
        return images
